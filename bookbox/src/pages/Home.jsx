    ...
    <div className="w-full h-auto page">
          ...
          {homeImages.map((image, index) => (
            <Link
              ...
              state={{
                title: image.title,
                link: null,
                fullLink: image.fullLink,
              }}
            >
              <div className="w-full h-[100%] md:h-[20em] bg-white">
                <div className="w-[100%] h-[15em] md:h-[100%] flex flex-row">
                  <div className="w-[55%] flex flex-col justify-center px-10">
                    <h3 className="text-[1em] sm:text-[1.5em] font-semibold md:text-[3em]">
                      {image.title}
                    </h3>
                    <h2 className="text-black text-[0.8em] sm:text-[1em] md:text-[2em]">
                      {image.author}
                    </h2>
                  </div>
      ...
      <div className="flex flex-col items-start my-5 flex-1">
        <div className="flex flex-row justify-between w-[100%] mb-5">
          ...
          <Link to="/all" state={{ title: "Popular", link: "relevance" }}>
          ...
          {popularBooks ? (
            popularBooks.map((book) => (
              <Book
                ...
                thumbnail={book.volumeInfo.imageLinks.thumbnail || "N/A"}
              />
            ))
          ) : (
      ...
      <div className="flex flex-col items-start my-5 flex-1">
        <div className="flex flex-row justify-between w-[100%] mb-5">
          ...
          <Link to="/all" state={{ title: "Fiction", link: "genre" }}>
            <span className="underline text-white capitalize">See All</span>
          </Link>
        </div>
      ...
      <div className="flex flex-col items-start my-5 flex-1">
        <div className="flex flex-row justify-between w-[100%] mb-5">
          ...
          <Link to="/all" state={{ title: "New", link: "newest" }}>
            <span className="underline text-white capitalize">See All</span>
          </Link>
        </div>
        <div className="flex flex-row no-wrap gap-x-3 pb-3 w-full overflow-x-scroll md:overflow-x-auto">
