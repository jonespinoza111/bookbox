...
const homeImages = [
  {
    ...
    fullLink: "https://www.googleapis.com/books/v1/volumes?q=intitle:Harry+Potter+inauthor:J.K.+Rowling&key=AIzaSyBxOOizpDa_Q3-SQ6g9_EktOK315JTXgVU",
    imageLink: 'https://prodimage.images-bn.com/pimages/9780545162074_p2_v1_s600x595.jpg',
  },
  {
    author: 'J.R.R. Tolkien',
    title: 'The Lord of the Rings Trilogy',
    fullLink: "https://www.googleapis.com/books/v1/volumes?q=intitle:The+Lord+of+the+Rings+inauthor:J.R.R.+Tolkien&key=AIzaSyBxOOizpDa_Q3-SQ6g9_EktOK315JTXgVU",
  ...
  },
  {
    ...
    fullLink: "https://www.googleapis.com/books/v1/volumes?q=intitle:Game+of+Thrones+inauthor:George+R.R.+Martin&key=AIzaSyBxOOizpDa_Q3-SQ6g9_EktOK315JTXgVU",
    ...
    <div className='w-full h-auto page'>
        ...
        <Slider {...settings}>
          {homeImages.map((image, index) => (
            <Link key={index} to='/all' state={{ title: image.title, link: null, fullLink: image.fullLink }}>
              <div className='w-full h-[100%] md:h-[20em] bg-white'>
                <div className='w-[100%] h-[15em] md:h-[100%] flex flex-row'>
                  <div className='w-[55%] flex flex-col justify-center px-10'>
                    <h3 className='text-[1em] sm:text-[1.5em] font-semibold md:text-[3em]'>{image.title}</h3>
                    <h2 className='text-black text-[0.8em] sm:text-[1em] md:text-[2em]'>{image.author}</h2>
                  </div>
